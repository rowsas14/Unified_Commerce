---
title: Customer Memberships Feature Spec
owner: Loyalty Module Owner
...
# Customer Memberships Feature Spec
...
Customer membership record and current points projection.
...
| Area | Document |
|---|---|
| Module README | [[07-modules/loyalty/README|Loyalty Module]] |
...
| Feature history | [[07-modules/loyalty/features/customer-memberships/feature-history|Customer Memberships History]] |
...
- Use approved entities: `customer_memberships`, `customers`, `loyalty_programs`, `membership_tiers`.
...
- [[08-user-flows/ecommerce-customer/register-login|Register Login]]
