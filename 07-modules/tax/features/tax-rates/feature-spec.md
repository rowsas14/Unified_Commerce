...
Effective VAT/GST/sales tax rates with country, start, end, and active status.
...
| Feature history | [[07-modules/tax/features/tax-rates/feature-history|Tax Rates History]] |
...
- Use approved entities: `tax_rates`.
