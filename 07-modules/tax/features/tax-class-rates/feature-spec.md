---
title: Tax Class Rates Feature Spec
owner: Tax Module Owner
...
# Tax Class Rates Feature Spec

## Module

[[07-modules/tax/README|Tax Module]]

## Purpose

Maps tax classes to rates with effective periods and overlap control.
...
| Area | Document |
|---|---|
| Module README | [[07-modules/tax/README|Tax Module]] |
...
| Feature history | [[07-modules/tax/features/tax-class-rates/feature-history|Tax Class Rates History]] |
...
- Use approved entities: `tax_class_rates`, `tax_classes`, `tax_rates`.
...
- [[08-user-flows/tenant-admin/tax-setup|Tax Setup]]
