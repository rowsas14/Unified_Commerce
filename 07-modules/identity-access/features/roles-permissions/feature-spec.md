---
title: Roles and Permissions Feature Spec
...
# Roles and Permissions Feature Spec
...
Tenant roles mapped to platform-owned permission catalog values.
...
| Feature history | [[07-modules/identity-access/features/roles-permissions/feature-history|Roles and Permissions History]] |
...
- Use approved entities: `roles`, `permissions`, `role_permissions`.
