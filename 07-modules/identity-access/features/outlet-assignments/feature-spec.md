---
title: Outlet Assignments Feature Spec
owner: Identity and Access Module Owner
...
# Outlet Assignments Feature Spec
...
Outlet-scope role assignment including employee code, relieved date, and primary outlet flag.
...
| Area | Document |
|---|---|
| Module README | [[07-modules/identity-access/README|Identity and Access Module]] |
...
| Feature history | [[07-modules/identity-access/features/outlet-assignments/feature-history|Outlet Assignments History]] |
...
- Use approved entities: `outlet_user_roles`, `outlets`, `users`, `roles`.
...
- [[08-user-flows/tenant-admin/outlet-user-assignment|Outlet User Assignment]]
