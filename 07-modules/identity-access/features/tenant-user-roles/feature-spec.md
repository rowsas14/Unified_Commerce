---
title: Tenant User Roles Feature Spec
...
# Tenant User Roles Feature Spec
...
Tenant-scope role assignment for users who operate across the tenant.
...
| Feature history | [[07-modules/identity-access/features/tenant-user-roles/feature-history|Tenant User Roles History]] |
...
- Use approved entities: `tenant_user_roles`, `roles`, `users`.
