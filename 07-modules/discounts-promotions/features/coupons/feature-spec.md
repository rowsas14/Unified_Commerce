...
Tenant coupon master with channel, validity, usage limits, and rule payload.
...
| Feature history | [[07-modules/discounts-promotions/features/coupons/feature-history|Coupons History]] |
...
- Use approved entities: `coupons`, `discount_types`.
...
- [[08-user-flows/tenant-admin/coupon-setup|Coupon Setup]]
