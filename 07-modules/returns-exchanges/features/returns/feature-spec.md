...
Return header for POS sale or e-commerce order with original and processing outlet context.
...
| Feature history | [[07-modules/returns-exchanges/features/returns/feature-history|Returns History]] |
...
- Use approved entities: `returns`, `sales`, `orders`, `customers`.
