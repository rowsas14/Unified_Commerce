---
title: Exchange Payment and Refund Allocations Feature Spec
...
# Exchange Payment and Refund Allocations Feature Spec
...
Allocates payment/refund records for exchange differences.
...
| Feature history | [[07-modules/returns-exchanges/features/exchange-payment-refund-allocations/feature-history|Exchange Payment and Refund Allocations History]] |
...
- Use approved entities: `exchange_payment_allocations`, `exchange_refund_allocations`, `payments`, `refunds`.
...
- [[08-user-flows/cashier/exchange-flow|Exchange Flow]]
