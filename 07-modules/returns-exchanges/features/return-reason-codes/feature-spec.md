---
title: Return Reason Codes Feature Spec
...
# Return Reason Codes Feature Spec
...
Tenant-owned return reason reference values.
...
| Feature history | [[07-modules/returns-exchanges/features/return-reason-codes/feature-history|Return Reason Codes History]] |
...
- Use approved entities: `return_reason_codes`.
...
- [[08-user-flows/tenant-admin/return-policy-setup|Return Policy Setup]]
