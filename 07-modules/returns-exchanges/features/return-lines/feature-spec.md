---
title: Return Lines Feature Spec
...
# Return Lines Feature Spec

## Module

[[07-modules/returns-exchanges/README|Returns and Exchanges Module]]

## Purpose

Returned line items linked to source sale line or order item.
...
| Feature history | [[07-modules/returns-exchanges/features/return-lines/feature-history|Return Lines History]] |
...
- Use approved entities: `return_lines`, `returns`, `sale_lines`, `order_items`, `product_variants`.
...
- [[08-user-flows/cashier/return-flow|Return Flow]]
