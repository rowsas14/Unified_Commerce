...
Tenant UI theme tokens for colors, spacing, typography, and default theme selection.
...
| Feature history | [[07-modules/settings-configuration/features/ui-themes/feature-history|UI Themes History]] |
...
- Use approved entities: `ui_themes`.
...
- [[08-user-flows/tenant-admin/theme-setup|Theme Setup]]
