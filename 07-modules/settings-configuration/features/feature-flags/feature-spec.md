---
title: Feature Flags Feature Spec
owner: Settings and Configuration Module Owner
...
# Feature Flags Feature Spec

## Module

[[07-modules/settings-configuration/README|Settings and Configuration Module]]

## Purpose

Tenant-side runtime configuration for entitled platform features.
...
| Area | Document |
|---|---|
| Module README | [[07-modules/settings-configuration/README|Settings and Configuration Module]] |
...
| Feature history | [[07-modules/settings-configuration/features/feature-flags/feature-history|Feature Flags History]] |
...
- Use approved entities: `feature_flags`, `platform_features`.
...
- [[08-user-flows/platform-admin/feature-assignment|Feature Assignment]]
- [[08-user-flows/tenant-admin/feature-configuration|Feature Configuration]]
