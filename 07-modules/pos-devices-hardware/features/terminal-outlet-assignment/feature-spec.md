---
title: Terminal Outlet Assignment Feature Spec
owner: POS Devices and Hardware Module Owner
...
tags:
  ...
  - terminal-outlet-assignment
---

# Terminal Outlet Assignment Feature Spec

## Module

[[07-modules/pos-devices-hardware/README|POS Devices and Hardware Module]]

## Purpose

Ensures device outlet context matches assigned till outlet before POS operation.
...
| Area | Document |
|---|---|
| Module README | [[07-modules/pos-devices-hardware/README|POS Devices and Hardware Module]] |
...
| Feature history | [[07-modules/pos-devices-hardware/features/terminal-outlet-assignment/feature-history|Terminal Outlet Assignment History]] |
...
- Use approved entities: `pos_devices`, `tills`, `outlets`.
...
- [[08-user-flows/tenant-admin/pos-device-setup|Pos Device Setup]]
