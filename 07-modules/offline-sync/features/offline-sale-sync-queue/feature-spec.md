---
title: Offline Sale Sync Queue Feature Spec
...
tags:
  ...
  - feature-spec
  - offline-sync
  - offline-sale-sync-queue
---

# Offline Sale Sync Queue Feature Spec
...
Typed offline sale staging queue linked one-to-one with offline sync items.
...
| Feature history | [[07-modules/offline-sync/features/offline-sale-sync-queue/feature-history|Offline Sale Sync Queue History]] |
...
- Use approved entities: `offline_sale_sync_queue`, `offline_sync_items`.
