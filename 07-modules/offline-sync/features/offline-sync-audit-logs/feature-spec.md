---
title: Offline Sync Audit Logs Feature Spec
...
# Offline Sync Audit Logs Feature Spec
...
Technical audit trail for sync lifecycle events.
...
| Feature history | [[07-modules/offline-sync/features/offline-sync-audit-logs/feature-history|Offline Sync Audit Logs History]] |
...
- Use approved entities: `offline_sync_audit_logs`, `offline_sync_batches`, `offline_sync_items`.
