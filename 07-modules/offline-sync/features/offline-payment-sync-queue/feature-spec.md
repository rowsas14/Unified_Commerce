---
title: Offline Payment Sync Queue Feature Spec
...
tags:
  ...
  - feature-spec
  - offline-sync
  - offline-payment-sync-queue
---

# Offline Payment Sync Queue Feature Spec
...
Typed offline payment staging queue linked one-to-one with offline sync items.
...
| Feature history | [[07-modules/offline-sync/features/offline-payment-sync-queue/feature-history|Offline Payment Sync Queue History]] |
...
- Use approved entities: `offline_payment_sync_queue`, `offline_sync_items`.
...
- [[08-user-flows/cashier/non-cash-payment|Non Cash Payment]]
