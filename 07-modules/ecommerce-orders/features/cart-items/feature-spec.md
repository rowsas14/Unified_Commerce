...
Variant line items inside cart with pricing snapshot.
...
| Feature history | [[07-modules/ecommerce-orders/features/cart-items/feature-history|Cart Items History]] |
...
- Use approved entities: `cart_items`, `carts`, `product_variants`.
