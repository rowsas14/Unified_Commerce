...
Shopping cart header for logged-in or guest customer context.
...
| Feature history | [[07-modules/ecommerce-orders/features/carts/feature-history|Carts History]] |
...
- Use approved entities: `carts`, `customers`.
