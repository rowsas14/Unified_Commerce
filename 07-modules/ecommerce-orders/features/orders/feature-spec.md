...
E-commerce order header with order/payment/fulfillment status fields.
...
| Feature history | [[07-modules/ecommerce-orders/features/orders/feature-history|Orders History]] |
...
- Use approved entities: `orders`, `customers`, `carts`, `outlets`.
...
- [[08-user-flows/ecommerce-ops/order-processing|Order Processing]]
