---
title: Purchase Receipts Feature Spec
...
# Purchase Receipts Feature Spec
...
Supplier stock receiving headers and line items that create purchase receipt stock movements when posted.
...
| Feature history | [[07-modules/inventory/features/purchase-receipts/feature-history|Purchase Receipts History]] |
...
- Use approved entities: `purchase_receipts`, `purchase_receipt_lines`, `suppliers`.
...
| `suppliers` | `id` | tenant_id -> tenants.id; name; status | Tenant supplier master. |
...
- [[08-user-flows/inventory-staff/purchase-receipt|Purchase Receipt]]
