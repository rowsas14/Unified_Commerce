---
title: Receipt Print Logs Feature Spec
owner: Receipts Module Owner
...
# Receipt Print Logs Feature Spec
...
Print, reprint, email, and download history with failure reason.
...
| Area | Document |
|---|---|
| Module README | [[07-modules/receipts/README|Receipts Module]] |
...
| Feature history | [[07-modules/receipts/features/receipt-print-logs/feature-history|Receipt Print Logs History]] |
...
- Use approved entities: `receipt_print_logs`, `receipts`.
...
- [[08-user-flows/cashier/receipt-reprint|Receipt Reprint]]
