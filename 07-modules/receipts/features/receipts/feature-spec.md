...
Stored receipt/invoice output with frozen payload and barcode lookup value.
...
| Feature history | [[07-modules/receipts/features/receipts/feature-history|Receipts History]] |
...
- Use approved entities: `receipts`, `sales`, `orders`, `returns`, `exchanges`.
