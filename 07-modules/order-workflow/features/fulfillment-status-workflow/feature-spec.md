---
title: Fulfillment Status Workflow Feature Spec
owner: Order Workflow Module Owner
...
# Fulfillment Status Workflow Feature Spec

## Module

[[07-modules/order-workflow/README|Order Workflow Module]]

## Purpose

Fulfillment status transition control for reserved, picking, pickup, delivery, collected, failed, and cancelled states.
...
| Area | Document |
|---|---|
| Module README | [[07-modules/order-workflow/README|Order Workflow Module]] |
...
| Feature history | [[07-modules/order-workflow/features/fulfillment-status-workflow/feature-history|Fulfillment Status Workflow History]] |
...
- Use approved entities: `orders`, `order_status_transitions`, `order_status_history`.
...
| `order_status_transitions` | `id` | status_type; from_status; to_status | Allowed status transitions. |
| `order_status_history` | `id` | tenant_id -> tenants.id; order_id -> orders.id | Status change history. |
...
- [[08-user-flows/ecommerce-ops/fulfillment|Fulfillment]]
