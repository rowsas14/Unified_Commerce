---
title: Order Status Transitions Feature Spec
...
# Order Status Transitions Feature Spec
...
Allowed status transitions for order, payment, and fulfillment workflows.
...
| Feature history | [[07-modules/order-workflow/features/order-status-transitions/feature-history|Order Status Transitions History]] |
...
- Use approved entities: `order_status_transitions`.
