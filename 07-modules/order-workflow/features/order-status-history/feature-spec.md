---
title: Order Status History Feature Spec
...
# Order Status History Feature Spec
...
Status change history with actor, timestamp, type, and reason.
...
| Feature history | [[07-modules/order-workflow/features/order-status-history/feature-history|Order Status History History]] |
...
- Use approved entities: `order_status_history`, `orders`.
