---
title: Payment Provider Configs Feature Spec
...
# Payment Provider Configs Feature Spec
...
Gateway/provider configuration using secret references instead of plain secrets.
...
| Feature history | [[07-modules/payments/features/payment-provider-configs/feature-history|Payment Provider Configs History]] |
...
- Use approved entities: `payment_provider_configs`.
...
- [[08-user-flows/tenant-admin/payment-provider-setup|Payment Provider Setup]]
