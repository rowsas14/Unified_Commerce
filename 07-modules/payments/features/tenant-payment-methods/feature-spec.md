---
title: Tenant Payment Methods Feature Spec
...
# Tenant Payment Methods Feature Spec
...
Tenant-enabled payment methods and non-secret method configuration.
...
| Feature history | [[07-modules/payments/features/tenant-payment-methods/feature-history|Tenant Payment Methods History]] |
...
- Use approved entities: `tenant_payment_methods`, `payment_method_types`, `payment_provider_configs`.
...
- [[08-user-flows/tenant-admin/payment-method-setup|Payment Method Setup]]
