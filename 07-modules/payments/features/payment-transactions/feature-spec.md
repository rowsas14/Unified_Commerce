---
title: Payment Transactions Feature Spec
...
# Payment Transactions Feature Spec
...
Gateway/provider event log per payment for auth, capture, void, refund, webhook, or failure.
...
| Feature history | [[07-modules/payments/features/payment-transactions/feature-history|Payment Transactions History]] |
...
- Use approved entities: `payment_transactions`, `payments`.
