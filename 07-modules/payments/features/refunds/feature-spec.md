...
Business refund header linked to original captured payment and optional outbound refund payment.
...
| Feature history | [[07-modules/payments/features/refunds/feature-history|Refunds History]] |
...
- Use approved entities: `refunds`, `payments`.
...
- [[08-user-flows/ecommerce-ops/refund-order|Refund Order]]
