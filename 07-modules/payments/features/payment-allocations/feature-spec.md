---
title: Payment Allocations Feature Spec
owner: Payments Module Owner
...
# Payment Allocations Feature Spec
...
Allocates captured payments to POS sales or e-commerce orders.
...
| Area | Document |
|---|---|
| Module README | [[07-modules/payments/README|Payments Module]] |
...
| Feature history | [[07-modules/payments/features/payment-allocations/feature-history|Payment Allocations History]] |
...
- Use approved entities: `sale_payment_allocations`, `order_payment_allocations`, `payments`, `sales`, `orders`.
...
- [[08-user-flows/cashier/split-payment|Split Payment]]
