---
title: OTP Verifications Feature Spec
...
# OTP Verifications Feature Spec

## Module

[[07-modules/otp-auth-security/README|OTP Auth Security Module]]

## Purpose

OTP issuance, attempt, resend, block, and verification history.
...
| Feature history | [[07-modules/otp-auth-security/features/otp-verifications/feature-history|OTP Verifications History]] |
...
- Use approved entities: `otp_verifications`, `users`, `customer_auth_accounts`.
