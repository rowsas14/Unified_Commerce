---
title: Price List Items Feature Spec
owner: Pricing Module Owner
...
# Price List Items Feature Spec

## Module

[[07-modules/pricing/README|Pricing Module]]

## Purpose

Variant prices inside a price list with list price and optional sale price.
...
| Area | Document |
|---|---|
| Module README | [[07-modules/pricing/README|Pricing Module]] |
...
| Feature history | [[07-modules/pricing/features/price-list-items/feature-history|Price List Items History]] |
...
- Use approved entities: `price_list_items`, `product_variants`, `price_lists`.
...
- [[08-user-flows/tenant-admin/pricing-setup|Pricing Setup]]
