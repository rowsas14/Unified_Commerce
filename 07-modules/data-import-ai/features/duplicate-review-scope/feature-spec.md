---
title: Duplicate Review Scope Feature Spec
owner: Data Import and AI Assisted Onboarding Module Owner
...
tags:
  ...
  - feature-spec
  - data-import-ai
  - duplicate-review-scope
---

# Duplicate Review Scope Feature Spec

## Module

[[07-modules/data-import-ai/README|Data Import and AI Assisted Onboarding Module]]

## Purpose

Scope-defined duplicate review behavior before saving imported product/customer data.
...
| Area | Document |
|---|---|
| Module README | [[07-modules/data-import-ai/README|Data Import and AI Assisted Onboarding Module]] |
...
| Feature history | [[07-modules/data-import-ai/features/duplicate-review-scope/feature-history|Duplicate Review Scope History]] |
...
- Use approved entities: `products`, `product_variants`, `customers`.
...
| --- | --- | --- | --- |
| `products` | `id` | tenant_id -> tenants.id; category_id; brand_id; tax_class_id; return_policy_id | Product master shared by POS and e-commerce. |
| `product_variants` | `id` | tenant_id -> tenants.id; product_id -> products.id; sku/barcode tenant unique | Sellable SKU/barcode unit. |
...
- [[08-user-flows/tenant-admin/data-import|Data Import]]
