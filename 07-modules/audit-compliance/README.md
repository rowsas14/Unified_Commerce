...
Owns immutable business audit trail expectations for platform and tenant actions, including sensitive actions and configuration changes.
...
| --- | --- | --- |
| [[07-modules/audit-compliance/features/audit-logs/feature-spec|Audit Logs]] | Immutable business audit trail for platform and tenant actions. | `audit_logs` |
| [[07-modules/audit-compliance/features/sensitive-action-audit/feature-spec|Sensitive Action Audit]] | Documents required audit coverage for refund, void, receipt reprint, stock adjustment, discount approval, feature changes, and offline conflict resolution. | `audit_logs` |
