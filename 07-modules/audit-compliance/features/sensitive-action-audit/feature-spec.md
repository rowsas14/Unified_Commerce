---
title: Sensitive Action Audit Feature Spec
owner: Audit and Compliance Module Owner
...
# Sensitive Action Audit Feature Spec

## Module

[[07-modules/audit-compliance/README|Audit and Compliance Module]]

## Purpose

Documents required audit coverage for refund, void, receipt reprint, stock adjustment, discount approval, feature changes, and offline conflict resolution.
...
| Area | Document |
|---|---|
| Module README | [[07-modules/audit-compliance/README|Audit and Compliance Module]] |
...
| Feature history | [[07-modules/audit-compliance/features/sensitive-action-audit/feature-history|Sensitive Action Audit History]] |
...
- Use approved entities: `audit_logs`.
...
| --- | --- | --- | --- |
| `audit_logs` | `id` | tenant_id nullable; actor ids; entity_type; action | Immutable business audit trail. |
...
- [[08-user-flows/manager/refund-approval|Refund Approval]]
- [[08-user-flows/manager/receipt-reprint-approval|Receipt Reprint Approval]]
