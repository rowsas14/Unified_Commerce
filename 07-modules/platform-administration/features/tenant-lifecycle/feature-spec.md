---
title: Tenant Lifecycle Feature Spec
owner: Platform Administration Module Owner
...
Create, activate, suspend, and support tenants without mixing tenant staff with platform users.
...
| Area | Document |
|---|---|
| Module README | [[07-modules/platform-administration/README|Platform Administration Module]] |
...
| Feature history | [[07-modules/platform-administration/features/tenant-lifecycle/feature-history|Tenant Lifecycle History]] |
...
- Use approved entities: `tenants`, `platform_users`.
...
- [[08-user-flows/platform-admin/tenant-onboarding|Tenant Onboarding]]
