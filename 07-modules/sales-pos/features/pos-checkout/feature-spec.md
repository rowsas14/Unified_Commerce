...
Barcode-first scan/add/pay cashier flow with active outlet, terminal, and session context.
...
| Area | Document |
|---|---|
| Module README | [[07-modules/sales-pos/README|Sales POS Module]] |
...
| Feature history | [[07-modules/sales-pos/features/pos-checkout/feature-history|POS Checkout History]] |
...
- Use approved entities: `sales`, `sale_lines`, `till_sessions`, `product_variants`.
