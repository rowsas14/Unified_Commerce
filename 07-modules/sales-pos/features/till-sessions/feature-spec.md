---
title: Till Sessions Feature Spec
...
Open/close session per till with opening float, expected cash, counted cash, variance, and approval fields.
...
| Feature history | [[07-modules/sales-pos/features/till-sessions/feature-history|Till Sessions History]] |
...
- Use approved entities: `till_sessions`, `tills`, `pos_devices`.
...
- [[08-user-flows/cashier/start-session|Start Session]]
