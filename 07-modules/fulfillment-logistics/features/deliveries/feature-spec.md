...
Delivery or pickup fulfillment header linked to order.
...
| Feature history | [[07-modules/fulfillment-logistics/features/deliveries/feature-history|Deliveries History]] |
...
- Use approved entities: `deliveries`, `orders`, `delivery_methods`.
