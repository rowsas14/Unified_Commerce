---
title: Delivery Items Feature Spec
owner: Fulfillment and Logistics Module Owner
...
# Delivery Items Feature Spec

## Module

[[07-modules/fulfillment-logistics/README|Fulfillment and Logistics Module]]

## Purpose

Line-level fulfilled quantities linked to order items.
...
| Area                    | Document                                                                     |                                    |
| ----------------------- | ---------------------------------------------------------------------------- | ---------------------------------- |
| Module README           | [[07-modules/fulfillment-logistics/README]]                                  | Fulfillment and Logistics Module]] |
...
| Feature history         | [[07-modules/fulfillment-logistics/features/delivery-items/feature-history]] | Delivery Items History]]           |
...
- Use approved entities: `delivery_items`, `deliveries`, `order_items`, `product_variants`.
