---
title: Document Sequences Feature Spec
owner: Tenant Management Module Owner
...
# Document Sequences Feature Spec
...
Tenant/outlet-aware business document number generator for sale, order, return, exchange, receipt, transfer, purchase receipt, adjustment, and delivery.
...
| Area | Document |
|---|---|
| Module README | [[07-modules/tenant-management/README|Tenant Management Module]] |
...
| Feature history | [[07-modules/tenant-management/features/document-sequences/feature-history|Document Sequences History]] |
...
- Use approved entities: `document_sequences`.
...
- [[08-user-flows/tenant-admin/document-number-setup|Document Number Setup]]
